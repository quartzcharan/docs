...
# Nextjs Guthub star Updator live [`Click here to refer`](https://nextra.site/docs/guide/ssg)
...
## Added another Languages to the Docs [Refer here](https://nextra.site/docs/guide/i18n)